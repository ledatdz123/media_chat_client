import {AiFillHeart, AiFillHome, AiFillMessage, AiFillPlusCircle, AiOutlineCiCircle, AiOutlineCompass, AiOutlineHeart, AiOutlineHome, AiOutlineMessage, AiOutlinePlusCircle, AiOutlineSearch} from 'react-icons/ai'
...
export const menu=[
    ...
    {
        title: "Explore", icon: <AiOutlineCompass className='text-2xl mr-5'/>, activeIcon: <AiOutlineCompass className='text-2xl mr-5'/>
    },
    {
